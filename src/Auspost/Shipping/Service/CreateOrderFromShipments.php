...
/**
 * Class CreateOrderFromShipments
 * @package Auspost\Shipping\Service
 */
class CreateOrderFromShipments extends AbstractShippingService
{
    /**
    ...
    public function __construct($config)
    {
        ...
        $this->schemaPath = realpath(__DIR__ . '/CreateOrderFromShipments/request.json');
